          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-emerald-200">Canada's Premier Junior Cricket Academy</p>
              </div>
            </div>
            
            <p className="text-emerald-100 leading-relaxed mb-6 max-w-md">
              Developing the next generation of Canadian cricket talent through expert Australian coaching, 
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white">Milton, Mississauga & Brampton</p>
                </div>
              </div>
            </div>
          </div>
